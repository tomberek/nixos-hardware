...
let
  ...
  surface_kernelPatches = [
    { name = "microsoft-surface-patches-linux-5.11.22";
      patch = null;
      extraConfig = ''
          #
    ...
    }
    {
      ...
      patch = patches + "/5.11/0001-surface3-oemb.patch";
    }
    {
      name = "ms-surface/0002-wifi";
      patch = patches + "/5.11/0002-wifi.patch";
    }
    {
      name = "ms-surface/0003-ipts";
      patch = patches + "/5.11/0003-ipts.patch";
    }
    {
      name = "ms-surface/0004-surface-sam-over-hid";
      patch = patches + "/5.11/0004-surface-sam-over-hid.patch";
    }
    {
      name = "ms-surface/0005-surface-sam";
      patch = patches + "/5.11/0005-surface-sam.patch";
    }
    {
      name = "ms-surface/0006-surface-hotplug";
      patch = patches + "/5.11/0006-surface-hotplug.patch";
    }
    {
      name = "ms-surface/0007-surface-typecover";
      patch = patches + "/5.11/0007-surface-typecover.patch";
    }
    {
      name = "ms-surface/0008-surface-sensors";
      patch = patches + "/5.11/0008-surface-sensors.patch";
    }
    {
      name = "ms-surface/0009-cameras";
      patch = patches + "/5.11/0009-cameras.patch";
    }
    {
      name = "ms-surface/0010-ath10k";
      patch = patches + "/5.11/0010-ath10k-firmware-override.patch";
    }
  ];
in (with pkgs; recurseIntoAttrs (linuxPackagesFor (
     callPackage ./linux-5.11.22.nix {
